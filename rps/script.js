        ...
        function finalMessage([yourScore, computerScore]) {
            if (yourScore === 0) {
                return { 'message': "You lost!Reload to play again", 'color': 'red' };
            } else if (yourScore === 0.5) {
                return { 'message': "You tied!Reload to play again", 'color': 'yellow' };
            } else {
                return { 'message': "You won!Reload to play again", 'color': 'green' };
            }
        }
